...
<div
  ...
  style="margin-top: 20px; padding: auto; border: none"
>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="pembungkus">
          ...
          <img
            src="<?= base_url("uploads/cover/$buku->sampul"); ?>"
            alt="cover"
      ...
      <div class="col-md-8 mt-5">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form
              action="<?= base_url("Buku/unduhBuku/$buku->file/$buku->id") ?>"
              method="post"
              target="_blank"
            >
            <?= csrf_field(); ?>
            ...
            <?php if(in_groups('admin')) : ?>
            <form
              action="<?= base_url("Buku/hapusBuku/$buku->slug") ?>"
              method="post"
            >
              <div class="col text-center">
                <input 
